package com.formacionviewnext.microservicios.app.respuestas.models.repository;
...
public interface RespuestaRespository extends MongoRepository<Respuesta, String> {
...
//		
	...
	public Iterable<Respuesta>findExamenesIdsConRespuestasPorAlumno(Long alumnoId);
